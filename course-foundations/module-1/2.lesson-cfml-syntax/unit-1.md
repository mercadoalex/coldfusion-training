...
:summary: ✏️ Using the IDE tab instead? Create the file here
---
In the **IDE tab**, right-click in the Explorer panel → **New File** → name it `syntax_script.cfm`, paste the content below, and save with **Ctrl+S**:
...
:summary: ✏️ Using the IDE tab instead? Create the file here
---
In the **IDE tab**, right-click in the Explorer panel → **New File** → name it `syntax_loop.cfm`, paste the content below, and save with **Ctrl+S**:
...
:summary: ✏️ Using the IDE tab instead? Create the file here
---
In the **IDE tab**, right-click in the Explorer panel → **New File** → name it `syntax_loop_all.cfm`, paste the content below, and save with **Ctrl+S**:
