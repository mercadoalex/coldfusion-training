...
kind: info
---
No full solution is provided here — use the hint, the skeleton, and the lessons. Once you pass all the checks, a **post-challenge review lesson** unlocks that walks through the complete solution with line-by-line explanations. The struggle now makes that review genuinely useful.
::
